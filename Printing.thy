theory Printing
  imports "02Typed/Typechecking" "03Debruijn/NameRemoval" "05Closure/ClosureConversion" 
    "06TreeCode/TreeCodeConversion" "06TreeCode/TailCallOptimization" "08ByteCode/CodeFlattening" 
...
| "print_eclosure (Lam\<^sub>e cs cd r) = Fun"

primrec print_bclosure :: "bclosure \<Rightarrow> print" where
  "print_bclosure (BConst n) = Number n"
